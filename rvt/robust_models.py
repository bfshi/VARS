...
from vars_block import Performer_Block, VARS_S_Block, VARS_D_Block, VARS_SD_Block
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, image_size=14, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
...
class Transformer(nn.Module):
    def __init__(self, base_dim, depth, heads, mlp_ratio,
        ...
        if config['attention'] == 'self-att':
            ...
            attention = VARS_S_Block
        elif config['attention'] == 'vars_d':
            attention = VARS_D_Block
        elif config['attention'] == 'vars_sd':
            attention = VARS_SD_Block
